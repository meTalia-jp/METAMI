...
- ファイル識別情報は画像・動画の内容を識別する情報です。将来的には、移動・
  コピー・改名後も同じ内容のファイルを確認し、以前のメモ、タグ、星評価などを
  再利用するために活用できます。現在は同じ内容のファイルへのMETAMIデータの
  コピー、専用の検索画面、自動追跡、重複整理、miniDBはまだ提供していません。
